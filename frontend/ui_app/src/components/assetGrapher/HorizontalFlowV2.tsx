...
import ReactFlow, {Node, Edge, ReactFlowProvider, Background} from 'reactflow';
...
import {LinNode, LinEdge} from "./flowGraph/nodeV2";
...
const HorizontalFlowV2 = (props: ReactFlowProps) => {
...
export default HorizontalFlowV2;
