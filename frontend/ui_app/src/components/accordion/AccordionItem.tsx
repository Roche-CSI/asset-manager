...
const AccordionItem = (props: AccordionItemProps) => {
  ...
  const { header, id, text, render } = item

  return (
    <div className='h-auto bg-white rounded-md border border-stroke p-4 shadow-9 dark:border-strokedark dark:shadow-none md:p-6 xl:p-7.5'>
      <div
      ...
      <div
        ref={contentEl}
        className={`h-auto mt-4 duration-200 ease-in-out ${active === id ? 'block' : 'hidden'
          }`}
      >
        {render()}
      </div>
