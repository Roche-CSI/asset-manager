...
class AwsTransportResource(TransportResource):
    """A class that represents a resource for AWS transport operations.

    This class is a subclass of the TransportResource class and provides additional functionality for AWS transport
    operations.
    """

    @classmethod
    def from_transport_resource(cls, res: TransportResource):
        """Creates an AwsTransportResource instance from a TransportResource instance.

        Parameters
        ----------
        res : TransportResource
            The TransportResource instance.

        Returns
        -------
        AwsTransportResource
            The created AwsTransportResource instance.
        """
        return cls(src=res.src, dst=res.dst, callback=res.callback)


class AwsUploadResource(AwsTransportResource):
    """A class that represents a resource for AWS upload operations.
    """

    @cached_property
    def dst_url(self) -> BlobStoreURL:
        """Returns the upload destination URL as a BlobStoreURL instance.

        Returns
        -------
        BlobStoreURL
            The destination URL as a BlobStoreURL instance.
        """
        return BlobStoreURL(url=self.dst)


class AwsDownloadResource(AwsTransportResource):
    """A class that represents a resource for AWS download operations.
    """

    @cached_property
    def src_url(self) -> BlobStoreURL:
        """Returns the source URL to download from as a BlobStoreURL instance.

        Returns
        -------
        BlobStoreURL
            The source URL as a BlobStoreURL instance.
        """
...
class AwsCopyResource(AwsTransportResource):
    """A class that represents a resource for AWS copy operations.
    """
    ...
    @cached_property
    def src_url(self) -> BlobStoreURL:
        """Returns the source URL as a BlobStoreURL instance.
    ...
    @cached_property
    def dst_url(self) -> BlobStoreURL:
        """Returns the destination URL as a BlobStoreURL instance.
