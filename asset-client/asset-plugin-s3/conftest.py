...
@pytest.fixture(scope="session")
def upload_test_url():
    return "s3://aws-test-bucket/rtd/asset_tool/test_data/asset_client/upload_test/{date_string}"


@pytest.fixture(scope="session")
def copy_test_url():
    return "s3://aws-test-bucket/rtd/asset_tool/test_data/asset_client/copy_tests/{date_string}"
