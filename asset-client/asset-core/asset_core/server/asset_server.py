...
class AssetServer:
    ...
    @property
    def user_id(self):
        return AssetStore.shared().user_id
    ...
    def find_asset(self, **kwargs):
        ...
        ----------
        kwargs: dict
                keys: class_name, alias, commit_hash
        Returns
        -------
    ...
    def create_asset_class(self, **kwargs) -> dict:
        ...
        return self.parse(self.post(url=self._asset_class_route(), data=data))
    ...
    def update_refs(self, data: dict):
        url = self.add_params(self._asset_ref_route(), {"user": self.user_id})
        return self.parse(self.post(url=url, data=data))
    ...
    def find_asset_versions(self, project_id: str,
        ...
        data = {'project_id': project_id, 'user': self.user_id}
        if version_names:
    ...
    def query_url(self, url: str, qstring):
