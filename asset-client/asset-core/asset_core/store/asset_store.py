...
class AssetStore(LoggingMixin):
    ...
    def repo_meta_backup_dir(self, repo_id):
        return os.path.join(self.store_backup_dir, "repos", repo_id)
    ...
    @property
    def store_backup_dir(self):
        return Configs.shared().asset_home.asset_store_backup_dir.format(asset_home=self.home_dir)
